// There is an issue with this code where it isn't recognizing the clicks. the
// following code, however, does work and just as you would expect. I'm not sure
// what the issue is but I'll have to return to this later
//
// #include <ncurses.h>
// #include <assert.h>
//
